...
portfolio.video = {
	...
	show: function(event_) {
		...
		jQuery('#layer').append('<video id="player" src="'+_$element.attr('data-layer')+'" width="320" height="240" style="text-align:center; margin-top: 20%; display: inline-block; "></video>')
		_player = new MediaElementPlayer('#player', {});
		jQuery('#layer').css({'display':'block'}).animate({'opacity':0.9})
	},
